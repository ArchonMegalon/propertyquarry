...
def test_fixed_seed_cross_language_authentication_vector(tmp_path: Path) -> None:
    ...
    expected_document = {
        ...
        "payload": {
            "tree_digest": (
                "sha256:d1254b1e3c98fa3da11ed9f787ebeb295"
                "3cceebceb69d42abf226e6fb908b802"
            ),
            "file_count": 21,
            "directory_count": 15,
            "role_count": 19,
            ...
            "package_payload_receipt_sha256": (
                "sha256:d67b82ce02f5a2c2853ba96fd24f4f646"
                "bc6bd80c4f29ea938b1ab888d212d13"
            ),
    ...
    assert _sha(tree_raw) == (
        "sha256:ece7c5ae55eaa598706a0c1bb6279c72"
        "5d318850bce1d088cadf8164aee4f37d"
    )
    ...
    assert _sha(authentication_raw) == (
        "sha256:c14c607c633932c9ac075a4b51ae3102"
        "ef6624a6806837cdf0b8a4a439b5e8af"
    )
    assert _sha(
        ...
        "sha256:219e955f8ee578e7ef80fe214695e3fc"
        "8eb7d05cc03b43b95e1be91f5b816ebf"
    )
    assert signature.hex() == (
        "2afe451e6469a0a0b5b2f7cdb638937c"
        "4ffc70a587b68542bebd0e00dd837ea6"
        "729a4836bf95e96b2a850415e22ef447"
        "9be8d1a2460bdcb152175007846a8801"
    )
