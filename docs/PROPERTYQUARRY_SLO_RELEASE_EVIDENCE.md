...
export PROPERTYQUARRY_MONITORING_RUNTIME_RECEIPT='_completion/propertyquarry_monitoring/runtime-proof.json'
export PROPERTYQUARRY_PROMETHEUS_RANGE_RECEIPT='_completion/propertyquarry_monitoring/range-receipt.json'
export PROPERTYQUARRY_PROMETHEUS_RANGE_RESPONSE='_completion/propertyquarry_monitoring/range-response.json'
export PROPERTYQUARRY_ALERT_DELIVERY_RECEIPT='_completion/propertyquarry_monitoring/alert-delivery.json'
export PROPERTYQUARRY_DASHBOARD_RENDER_RECEIPT='_completion/propertyquarry_monitoring/dashboard-render.json'
export PROPERTYQUARRY_STRUCTURED_LOG_QUERY_RECEIPT='_completion/propertyquarry_monitoring/structured-log-query.json'
export PROPERTYQUARRY_DISTRIBUTED_TRACE_QUERY_RECEIPT='_completion/propertyquarry_monitoring/distributed-trace-query.json'
