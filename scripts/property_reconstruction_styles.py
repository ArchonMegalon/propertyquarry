...
_STYLE_ROWS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "decor": (
            ("healthy-plant", "plant", "healthy_plants", "foliage", (-1.46, 0.58, -0.82), (0.64, 1.38, 0.64)),
            ("canopy-plant", "plant", "layered_greenery", "foliage", (1.46, 0.52, -0.80), (0.54, 1.16, 0.54)),
            ("rattan-shelf", "shelf", "natural_fibres", "rattan", (1.48, 0.62, 0.78), (0.62, 1.24, 0.32)),
            ("rattan-chair", "rattan_chair", "rattan", "rattan", (0.92, 0.43, 0.62), (0.68, 0.86, 0.68)),
            ("warm-wood-table", "table", "warm_wood", "timber", (-0.92, 0.29, 0.74), (0.64, 0.58, 0.54)),
            ("timber-bench", "bench", "warm_wood_detail", "timber", (-0.18, 0.27, -0.88), (0.86, 0.54, 0.40)),
            ("linen-rug", "rug", "linen", "textile", (-0.04, 0.03, 0.02), (2.02, 0.03, 1.42)),
            ("botanical-vessels", "vessels", "botanical_objects", "accent", (-1.48, 0.34, 0.74), (0.46, 0.68, 0.36)),
        ),
    },
    {
        "id": "landhaus",
