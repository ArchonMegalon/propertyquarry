...
GENERATED_RECONSTRUCTION_VIEWER_VERSION = "propertyquarry_3d_tour_viewer_v4"
...
_STYLE_ROWS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "decor": (
            ("modular-storage", "shelf", "modular_storage", "stone", (-1.08, 0.62, -0.70), (0.72, 1.24, 0.32)),
            ("blue-cabinet", "box", "bright_storage", "accent", (0.98, 0.36, -0.66), (0.72, 0.72, 0.36)),
            ("yellow-stool", "cylinder", "simple_lines", "metal", (-0.78, 0.24, 0.80), (0.34, 0.48, 0.34)),
