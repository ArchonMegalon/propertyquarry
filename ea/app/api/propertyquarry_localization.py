...
_DE_AT = {
    ...
    "Save review packet": "Prüfpaket speichern",
    "Save shortlist packet": "Auswahllisten-Paket speichern",
    "Saved packets": "Gespeicherte Pakete",
    "Saved packet": "Gespeichertes Paket",
    "Save local review packets and keep the replies together.": "Speichern Sie lokale Prüfpakete und halten Sie die Antworten zusammen.",
    "Keep only packets that are ready to review. Replies stay here before they change the search.": "Behalten Sie nur Pakete, die zur Prüfung bereit sind. Antworten bleiben hier, bevor sie die Suche ändern.",
    "No saved packet is ready yet. Finish a search, open a strong home, and save the first local packet.": "Noch kein gespeichertes Paket bereit. Schließen Sie eine Suche ab, öffnen Sie eine passende Immobilie und speichern Sie das erste lokale Paket.",
    "Before you visit": "Vor der Besichtigung",
    "Recommendation": "Empfehlung",
    "Predicted reaction": "Vorhergesagte Reaktion",
    "Not scored yet.": "Noch nicht bewertet.",
    "Still unknown": "Noch unbekannt",
    "Trade-off": "Abwägung",
    "Blocker": "Ausschluss",
    "Ask the agent": "Den Berater fragen",
    "Save recipient": "Empfänger speichern",
    "Paste external link": "Externen Link einfügen",
    "Save external link": "Externen Link speichern",
...
_ES_CR = {
    ...
    "Save review packet": "Guardar paquete de revisión",
    "Save shortlist packet": "Guardar paquete de preselección",
    "Saved packets": "Paquetes guardados",
    "Saved packet": "Paquete guardado",
    "Save local review packets and keep the replies together.": "Guarde paquetes de revisión locales y mantenga las respuestas juntas.",
    "Keep only packets that are ready to review. Replies stay here before they change the search.": "Conserve solo los paquetes listos para revisar. Las respuestas se quedan aquí antes de cambiar la búsqueda.",
    "No saved packet is ready yet. Finish a search, open a strong home, and save the first local packet.": "Aún no hay un paquete guardado. Termine una búsqueda, abra una vivienda sólida y guarde el primer paquete local.",
    "Before you visit": "Antes de visitar",
    "Recommendation": "Recomendación",
    "Predicted reaction": "Reacción prevista",
    "Not scored yet.": "Aún sin puntuación.",
    "Still unknown": "Aún desconocido",
    "Trade-off": "Compensación",
    "Blocker": "Bloqueo",
    "Ask the agent": "Preguntar al asesor",
    "Save recipient": "Guardar destinatario",
    "Paste external link": "Pegar enlace externo",
    "Save external link": "Guardar enlace externo",
    "No recipients yet.": "Aún no hay destinatarios.",
